  ...
  void didUpdateWidget(TreeAnimationWidget oldWidget) {
    ...
    if (widget.speed != oldWidget.speed) {
      ...
      if (_treeController.isAnimating) {
        _treeController.duration =
            Duration(milliseconds: (10000 / _treeSpeed).round());
      }
    }
  ...
  Widget build(BuildContext context) {
    if (!widget.isActive) {
      return const SizedBox
          .shrink(); // Veya duraklatılmış durumda gösterilecek sabit bir görünüm
    }
