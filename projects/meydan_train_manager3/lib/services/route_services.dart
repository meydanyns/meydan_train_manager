...
class RouteService {
  ...
  static List<List<Station>> routes = [
    ...
    [
      ...
      Station(name: 'Paşalı', latitude: 39.061879, longitude: 35.036802),
      Station(name: 'Himmetdede', latitude: 38.910037, longitude: 35.085560),
    ...
    [
      ...
      Station(name: 'Bor', latitude: 37.887704, longitude: 34.562686),
    ...
    ], //  toprakkale- fevzipaşa hattı
    [
      Station(name: 'Toprakkale', latitude: 37.066547, longitude: 36.145709),
      Station(name: 'Osmaniye', latitude: 37.079662, longitude: 36.237489),
      Station(name: 'mamure', latitude: 37.136669, longitude: 36.317649),
      Station(name: 'Yarbaşı', latitude: 37.189803, longitude: 36.424693),
      Station(name: 'Taşoluk', latitude: 37.178254, longitude: 36.503385),
      Station(name: 'Bahçeşehir D.', latitude: 37.201420, longitude: 36.578078),
      Station(name: 'Ayran', latitude: 37.184018, longitude: 36.619014),
      Station(name: 'Fevzipaşa', latitude: 37.097659, longitude: 36.638143),
    ],
    ...
    [
      ...
      Station(name: 'Suluova', latitude: 40.836465, longitude: 35.639026),
    ...
    // Hat6:  Malatya-Fevzipaşa Hattı
    [
      Station(name: 'Malatya', latitude: 38.353104, longitude: 38.280001),
      Station(name: 'Karapınar', latitude: 38.290706, longitude: 38.043826),
      Station(name: 'Doğanşehir', latitude: 38.088464, longitude: 37.874956),
      Station(name: 'Kadılı', latitude: 37.971137, longitude: 37.670830),
      Station(name: 'Kapıdere', latitude: 37.970960, longitude: 37.670933),
      Station(name: 'Gölbaşı', latitude: 37.788399, longitude: 37.634738),
      Station(name: 'Çelik', latitude: 37.699636, longitude: 37.507535),
      Station(name: 'Haydarlı', latitude: 37.586501, longitude: 37.452639),
      Station(name: 'Pazarcık', latitude: 37.490843, longitude: 37.290008),
      Station(name: 'Narlı', latitude: 37.393836, longitude: 37.137655),
      Station(name: 'Köprüağzı', latitude: 37.361307, longitude: 37.001133),
      Station(name: 'Türkoğlu', latitude: 37.372215, longitude: 36.858222),
      Station(name: 'Beyoğlu', latitude: 37.287464, longitude: 36.791065),
      Station(name: 'Nurdağ', latitude: 37.174955, longitude: 36.748933),
      Station(name: 'Fevzipaşa', latitude: 37.097659, longitude: 36.638143),
    ],
    ...
    [
      ...
      Station(name: 'Kürk', latitude: 38.461436, longitude: 39.274030),
    ...
    // Hat8:  Dinar- Ortaklar Hattı
    [
      Station(name: 'Dinar', latitude: 38.062272, longitude: 30.155311),
      Station(name: 'Sütlaç', latitude: 38.128935, longitude: 29.991078),
      Station(name: 'Dazkırı', latitude: 37.902311, longitude: 29.862748),
      Station(name: 'Çardak', latitude: 37.821497, longitude: 29.679485),
      Station(name: 'Kaklık', latitude: 37.826859, longitude: 29.414662),
      Station(name: 'Böceli', latitude: 37.801950, longitude: 29.208124),
      Station(name: 'Goncalı', latitude: 37.847263, longitude: 29.117081),
      Station(name: 'Sarayköy', latitude: 37.913720, longitude: 28.926648),
      Station(name: 'Buharkent', latitude: 37.952589, longitude: 28.738658),
      Station(name: 'Horsunlu', latitude: 37.914728, longitude: 28.590850),
      Station(name: 'Nazilli', latitude: 37.914083, longitude: 28.328322),
      Station(name: 'Köşk', latitude: 37.851528, longitude: 28.051992),
      Station(name: 'Aydın', latitude: 37.847821, longitude: 27.838329),
      Station(name: 'İncirliova', latitude: 37.853959, longitude: 27.724623),
      Station(name: 'Ortaklar', latitude: 37.886202, longitude: 27.504022),
    ],
    ...
    [
      ...
      Station(name: 'Suveren', latitude: 38.718799, longitude: 40.326282),
      Station(name: 'Genç', latitude: 38.751475, longitude: 40.556416),
      Station(name: 'Oymapınar', latitude: 38.858741, longitude: 40.970740),
      Station(name: 'Yamanlar', latitude: 38.754360, longitude: 41.129889),
